package mail.rasul0301;
// Работа с типом данных int и операторами %, >, ==, &&,  if..else на примере задачи:
...
//Чтобы не нагружать программу, не стал прописывать подробные условия для сценариев,
//когда введено не целое число, а строка или дробь, или число не из диапазона int.
//Объединил все эти проверки в проверку hasNextInt().
